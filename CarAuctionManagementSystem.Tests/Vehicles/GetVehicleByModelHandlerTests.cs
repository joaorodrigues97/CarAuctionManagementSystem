...
public class GetVehicleByModelHandlerTests
{
    private readonly Mock<IVehicleRepository> _vehicleRepositoryMock;
    private readonly GetVehicleByModelQueryHandler _handler;
    
    public GetVehicleByModelHandlerTests()
    {
        _vehicleRepositoryMock = new Mock<IVehicleRepository>();
        _handler = new GetVehicleByModelQueryHandler(_vehicleRepositoryMock.Object);
    }
    ...
    {
        // Arrange
        var command = new GetVehicleByModelQuery("S-MAX");
        ...
        _vehicleRepositoryMock.Setup(vehicleMock => vehicleMock.GetVehicleByModel(command.Model, CancellationToken.None))
            .Returns(vehicle);
